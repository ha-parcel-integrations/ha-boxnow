"""pytest configuration for the BoxNow test suite."""
import sys
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.boxnow`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.boxnow import parcels

    parcels._unmapped_logged.clear()
    parcels._barcode_mismatches_logged.clear()
    yield
