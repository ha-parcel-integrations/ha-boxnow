...
[![Downloads](https://img.shields.io/github/downloads/ha-parcel-integrations/ha-boxnow/total.svg)](https://github.com/ha-parcel-integrations/ha-boxnow/releases)
...
- **Hot (every 15 minutes)** — while any tracked parcel is out for delivery
  ...
  BoxNow, whose tracking endpoint has never reported a delivery window at
  all).
...
- A small, fixed per-hub offset is added on top, so not every BoxNow hub out
